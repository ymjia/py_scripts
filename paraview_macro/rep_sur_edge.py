# -*- coding: utf-8 -*-
## @file rep_surface.py
## @brief set representation to surface with edges for current source
## @author jiayanming
import os
import sys
...
cur_p.Representation = 'Surface With Edges'
cur_p.BackfaceRepresentation = 'Surface With Edges'
